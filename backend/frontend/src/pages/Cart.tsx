...
export default function Cart() {
    ...
    const { items: cartItems, isLoading } = useTypedSelector(state => state.getMyCart)

    const { isSuccess, isLoading: loadingRemovedRes } = useTypedSelector(state => state.removeFromCart)
    ...
    return (
        <div className='grid justify-center'>
            {isLoading || loadingRemovedRes && <Loader />}

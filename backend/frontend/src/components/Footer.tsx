    ...
    return (
        <>
            ...
            <div className="p-1 text-center">
                Developed by
                <a href="https://realenlight.com" className="bg-lightBlue underline"> RealEnlight.com </a>
                For bussiness with us Whatsapp us at <a className="bg-lightBlue  underline" href="tel:923117907036">0311 7907036</a>
            </div>
        </>
    )
}
